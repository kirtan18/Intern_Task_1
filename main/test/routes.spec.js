...
describe('Routes', () => {
    let updateModel,skillIdsModel;
    describe('GET /users', () => {
        it('Successfully return all users array', async () => {
    ...
    describe('GET /skills', () => {
        it('Successfully return all skills array', async () => {
            return chai.request(server)
                .get('/skills')
                .then((res) => {
                    expect(res.status).to.be.equal(200);
    ...
    describe('GET /userWithSkill', () => {
        ...
        it('Successfully return all userWithSkills array', async () => {
            return chai.request(server)
                .get('/userWithSkill')
                .then((res) => {
                    expect(res.body).to.be.an('array');
    ...
    describe('GET /sort', () => {
        ...
        it('Successfully return sorted users', async () => {
            return chai.request(server)
        ...
        it('Return validation failed error', async () => {
            return chai.request(server)
    ...
    describe('GET /birthdayUsers', () => {
        ...
        it('Successfully return birthday users', async () => {
            return chai.request(server)
                .get('/birthday')
                .then((res) => {
                    expect(res.status).to.be.equal(200);
    ...
    describe('PUT /updateUserById', () => {
        ...
        it('Successfully update user by Id', async() => {
           return chai.request(server)
                .put('/update/1')
                .send(updateModel)
                .then((res) => {
    ...
    describe('GET /get Users By Match Skills' , ()=>{
        ...
        it('Successfully get user by match skills' , async() =>{
            return chai.request(server)
    ...
    describe('PUT /add Skills In User By Id' , ()=>{
        ...
        it('successfully add skills in user' , async()=>{
            return chai.request(server)
                   .put('/addSkill/3')
                   .send(skillIdsModel)
                   .then((res)=>{
        ...
        it('return Error when skill_id already present in user' , async()=>{
            return chai.request(server)
                   .put('/addSkill/3')
                   .send(skillIdsModel)
                   .then((res)=>{
    ...
    describe('DELETE /remove Skills In User By Id' , ()=>{
        ...
        it('successfully remove skills in user' , async()=>{
            return chai.request(server)
        ...
        it('Return Not found error when skillId not present in user' , async()=>{
            return chai.request(server)
                   .put('/removeSkill/3')
                   .send(skillIdsModel)
                   .then((res)=>{
